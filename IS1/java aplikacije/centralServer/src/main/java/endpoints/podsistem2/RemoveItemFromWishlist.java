...
@Path("ps2/wishlist/remove/{userId}")
public class RemoveItemFromWishlist {
    ...
    public Response remove(@PathParam("userId") String userId,
        ...
        try (JMSContext context = connectionFactory.createContext()) {
            ...
            objMsg.setIntProperty("redniBrojZahteva", 13);
            ...
            Logger.getLogger(RemoveItemFromWishlist.class.getName()).log(Level.SEVERE, null, ex);
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity("GRESKA u RemoveItemFromWishlist.remove()").build();
        }
    }
}
