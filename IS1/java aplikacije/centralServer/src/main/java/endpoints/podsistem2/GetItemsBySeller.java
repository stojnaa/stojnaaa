...
@Path("ps2/items/seller/{sellerId}")
public class GetItemsBySeller {
    ...
    @GET
    public Response getItems(@PathParam("sellerId") String sellerId) {
        try (JMSContext context = connectionFactory.createContext()) {
            ...
            objMsg.setIntProperty("redniBrojZahteva", 18);
            ...
            Logger.getLogger(GetItemsBySeller.class.getName()).log(Level.SEVERE, null, ex);
            return Response.status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity("GRESKA u GetItemsBySeller.getItems()").build();
        }
    }
}
